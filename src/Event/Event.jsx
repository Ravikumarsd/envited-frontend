...
const Event = () => {
  return (
    <div className="md:flex h-[90vh] justify-center items-center">
      <div className="md:flex flex-col lg:flex-row-reverse justify-around">
        <div>
          <img
            className="sm:w-[375px] sm:h-[375px] md:w-[593px] md:h-[593px] lg:w-[500px] lg:h-[500px]"
        ...
        <div className="mt-6 ml-8 md:ml-0 self-start lg:h-[500px]">
          <div>
